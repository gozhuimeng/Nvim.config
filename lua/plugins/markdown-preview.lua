return {
    ...
    keys = {
        { "<leader>mp", ":MarkdownPreviewToggle<CR>", desc = "启用预览窗口", mode = { "n" }, silent = true },
        -- { "<C-m>p", "<CMD>MarkdownPreviewToggle<CR>", desc = "启用预览窗口", mode = { "i" }, silent = true },  -- 该快捷键会导致回车卡顿，暂时未知原因，故注释
        { "<leader>mP", ":MarkdownPreview<CR>", desc = "强制启用预览窗口", mode = { "n" }, silent = true },
        { "<leader>ms", ":MarkdownPreviewStop<CR>", desc = "停用预览窗口", mode = { "n" }, silent = true },
